...
@record class Cli(val pathSep: C) {
  ...
  def parseFmide(args: ISZ[String], i: Z): Option[FmideTopOption] = {
    ...
    var awas: Option[String] = Some("1.2023.07271345.065b5fa")
    ...
    var gumbo: Option[String] = Some("1.2023.08021014.21d7eb2")
    var hamr: Option[String] = Some("1.2023.07271345.065b5fa")
