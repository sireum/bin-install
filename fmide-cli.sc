...
val fmideTool: Tool = Tool(
  ...
  opts = ISZ(
    Opt(name = "awas", longKey = "awas", shortKey = None(),
      tpe = Type.Str(sep = None(), default = Some("1.2025.01061040.5a6dd932")), description = "AWAS version"),
    ...
    Opt(name = "hamr", longKey = "hamr", shortKey = None(),
      tpe = Type.Str(sep = None(), default = Some("1.2025.01061040.5a6dd932")), description = "Sireum HAMR version"),
