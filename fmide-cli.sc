...
val fmideTool: Tool = Tool(
  ...
  opts = ISZ(
    Opt(name = "awas", longKey = "awas", shortKey = None(),
      tpe = Type.Str(sep = None(), default = Some("1.2024.10281024.2762e991")), description = "AWAS version"),
    ...
    Opt(name = "hamr", longKey = "hamr", shortKey = None(),
      tpe = Type.Str(sep = None(), default = Some("1.2024.10281024.2762e991")), description = "Sireum HAMR version"),
