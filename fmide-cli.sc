...
val fmideTool: Tool = Tool(
  ...
  opts = ISZ(
    Opt(name = "awas", longKey = "awas", shortKey = None(),
      tpe = Type.Str(sep = None(), default = Some("1.2024.10301208.4e3e80ef")), description = "AWAS version"),
    ...
    Opt(name = "gumbo", longKey = "gumbo", shortKey = None(),
      tpe = Type.Str(sep = None(), default = Some("1.2024.10181001.07c00045")), description = "Sireum GUMBO version"),
    Opt(name = "hamr", longKey = "hamr", shortKey = None(),
      tpe = Type.Str(sep = None(), default = Some("1.2024.10301208.4e3e80ef")), description = "Sireum HAMR version"),
