...
val fmideTool: Tool = Tool(
  ...
  opts = ISZ(
    Opt(name = "awas", longKey = "awas", shortKey = None(),
      tpe = Type.Str(sep = None(), default = Some("1.2023.10231030.6b82283")), description = "AWAS version"),
    ...
    Opt(name = "hamr", longKey = "hamr", shortKey = None(),
      tpe = Type.Str(sep = None(), default = Some("1.2023.10231030.6b82283")), description = "Sireum HAMR version"),
